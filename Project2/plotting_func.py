...
def plot_grid(x,y,cmap_type,Z=None,filename=None,save_fig=False,ax=None,title = None, **kwargs):
    ...
    if str(type(Z)) == "<class 'numpy.ndarray'>":
        cmap = plt.colormaps[cmap_type]
        shading = ax.pcolormesh(x,y,Z,shading='flat',vmin=Z.min(),vmax=Z.max(),cmap=cmap)
